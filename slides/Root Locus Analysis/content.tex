...
\frametitle{Root locus method: design criteria}
	...
	\justify
		...
		\vspace{1em}
		We want to design a proportional controller K that leads the closed-loop systems to have  damping-ratio = 0.5.
	\end{example}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.9\linewidth]{matlab_ex3}
		\end{figure}
		\end{column}
		
		\begin{column}{0.5\textwidth}
			MATLAB will return the numerical result for the point\\ you selected. E.g.:
			\begin{itemize}
...
\begin{frame}
	\begin{exampleblock}{}
		\justify
		To corroborate that the design specifications have been met, you should plot the step response of the closed-loop system you designed. You can do that with MATLAB by using the command \textbf{step(sys)}.\\
		\vspace{1em}
