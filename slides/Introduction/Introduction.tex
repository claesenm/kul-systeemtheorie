...
\bigskip
Dynamical systems can be devided into two types: discrete and continuous systems.
\end{frame}
...
\column{.3\textwidth}
\centering \textbf{Delay elements}\\

\usetikzlibrary{positioning,intersections,shapes.geometric,fit,arrows,decorations.shapes,decorations.markings}

\tikzstyle{register} = [rectangle, draw, text centered]
\bigskip
\begin{tikzpicture}
...
\bigskip
\begin{figure}
\includegraphics[discrete_system}
\end{figure}
\end{frame}
